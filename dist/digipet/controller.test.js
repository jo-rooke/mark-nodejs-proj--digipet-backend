...
describe("rehomeDigipet", () => {
    it("sets the digipet object to undefined", () => {
        ...
        expect(model_1.getDigipet()).toStrictEqual(null);
    });
});
describe("ignoreDigipet", () => {
    it("decreases all digipet stats by 10 to a possible floor of 0", () => {
        // setup
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
        expect(model_1.getDigipet()).toStrictEqual(model_1.INITIAL_DIGIPET);
        // act
    ...
    it("cannot decrease nutrition below 0", () => {
        // setup
        model_1.setDigipet({ happiness: 10, nutrition: 5, discipline: 50 });
        // act
        controller_1.ignoreDigipet();
        // assert
