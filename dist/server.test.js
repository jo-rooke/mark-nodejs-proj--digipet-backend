...
describe("action routes", () => {
    ...
    describe("GET /digipet/rehome", () => {
        test("if the user has a digipet, it calls rehomeDigipet controller and responds with a message about rehoming the digipet", () => __awaiter(void 0, void 0, void 0, function* () {
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
    ...
    describe("GET /digipet/ignore", () => {
        test("if the user has a digipet, it calls the ignoreDigipet controller and responds with a message about ignoring the digipet", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
